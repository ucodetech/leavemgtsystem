...
//move file
    public static function moveFile($temp_path, $dir,$file, $new_filename = ''){
        $fileObj = new static;
...
//        }
        ...
        $fileObj->_path = "{$dir}{$dirs}{$file_name}";
        $absolute_path = APPROOT."{$dirs}lms_Admin{$dirs}$fileObj->_path";
    ...
    public function  moveToDatabase($table, $fields = array()){
     ...
     public function  moveToDatabaseUpdate($table,$userid, $fields = array()){
        return $this->_db->update($table,'id',$userid, $fields);
